...
public class MainActivity extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.addTab(ab.newTab().setText("Donut").setTabListener(this));
        ab.addTab(ab.newTab().setText("Eclair").setTabListener(this));
        ab.addTab(ab.newTab().setText("Nougat").setTabListener(this));

        ab.setStackedBackgroundDrawable(new ColorDrawable(getResources().getColor(R.color.cardview_dark_background)));
    }
